...
export default {
  ...
  errors: {
    cloudNoProvider: '未选择云同步服务提供方',
    cloudAuthFailed: '云端凭据认证失败，请检查账号密码或 Token',
    cloudNetworkError: '无法连接到云服务，请检查网络连接或 URL',
    cloudDirNotFound: '目标目录不存在，请先在网盘手动创建该文件夹',
    cloudFileNotFound: '云端未找到备份数据文件',
    cloudUploadFailed: '上传至云端失败',
    cloudFetchFailed: '从云端拉取数据失败',
    cloudTokenRequired: '缺少 GitHub 访问令牌 (PAT)',
    cloudGistIdRequired: '缺少 Gist ID',
    cloudConflict: '云端版本比本地更晚更新，已阻止自动覆盖',
    e2eeLocked: '端到端加密主密码未解锁',
    e2eeDecryptFailed: '解密失败：主密码错误',
    cloudImportFailed: '云端备份数据解析恢复失败',
